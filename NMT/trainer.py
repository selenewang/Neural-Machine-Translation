...
from CONSTANTS import VOCAB, LEARNING_RATE, EPOCHS, DEBUG_LENGTH, HIDDEN_SIZE, DEBUG, use_cuda
...
def main(language_in, language_out, dataset_path):
    ...
    # Initialize model
    model_sections, optimizing_params = model_initializer(VOCAB, VOCAB)
